...
# 🦐 Lobster is ready! Listening for jobs...`} language="bash" />
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-emerald-500/50 transition-all hover:transform hover:scale-105 cursor-pointer">
...
export default ConnectGuideContent