...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('artifact_id', sa.String(64), sa.ForeignKey('artifacts.artifact_id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('job_id', sa.String(64), sa.ForeignKey('jobs.job_id'), nullable=False),
        sa.Column('payer_id', sa.String(64), sa.ForeignKey('agents.agent_id'), nullable=False),
    ...
    op.create_table(
        'message_delivery',
        sa.Column('message_id', sa.String(64), primary_key=True),
        sa.Column('recipient_id', sa.String(64), sa.ForeignKey('agents.agent_id'), nullable=False),
